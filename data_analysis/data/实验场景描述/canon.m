...
[~,i] = size(t4);
[~,j] = size(t8);% Modification functions
...
blks = zeros(1,k);% Blank Block
blkblock = [blkf blkf blkf blkf blkf blkf blkf blkf...
    blkf blkf blkf blkf blkf blkf blkf blkf];% Base Melody
cello = [do1f do1f so0f so0f la0f la0f mi0f mi0f...
    fa0f fa0f do0f do0f fa0f fa0f so0f so0f];% So-FUCKING-Long Melody 
